...
# Created 2024-11-07 15:59:38

CASEDIR="/glade/work/yhoussam/cases/gmom.e23.GJRAv3.TL319_t025_hycom1_N75.tx1_4.leith_GM.028"

/glade/work/yhoussam/code/cesm2_3_beta17_t025_res/cime/scripts/create_newcase --case gmom.e23.GJRAv3.TL319_t025_hycom1_N75.tx1_4.leith_GM.028 --res TL319_t025 --compset 2000_DATM%JRA-1p4-2018_SLND_CICE_MOM6_DROF%JRA-1p4-2018_SGLC_SWAV --run-unsupported --project p93300612
...
./xmlchange --subgroup case.run CHARGE_ACCOUNT=P93300012

./xmlchange --subgroup case.st_archive CHARGE_ACCOUNT=P93300012
