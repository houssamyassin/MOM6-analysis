...
cp /glade/work/gmarques/cesm.cases/G/gmom.e23_a16e.GJRAv4.TL319_t025_zstar_N65.t025_test/SourceMods/src.mom/diag_table SourceMods/src.mom/
...
sed -i 's#gmom.e23_a16e.GJRAv4.TL319_t025_zstar_N65.t025_test#'"$(basename "$PWD")"'#g' SourceMods/src.mom/diag_table
