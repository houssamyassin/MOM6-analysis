...
# Created 2024-07-09 06:44:58

CASEDIR="/glade/work/yhoussam/cases/gmom.e23.GJRAv3.TL319_t025_hycom1_N75.tx1_4.smag_control.003"

/glade/work/yhoussam/code/cesm2_3_beta17_t025/cime/scripts/create_newcase --case gmom.e23.GJRAv3.TL319_t025_hycom1_N75.tx1_4.smag_control.003 --res TL319_t025 --compset 2000_DATM%JRA-1p4-2018_SLND_CICE_MOM6_DROF%JRA-1p4-2018_SGLC_SWAV --run-unsupported --project p93300612
